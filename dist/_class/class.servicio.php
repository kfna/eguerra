...
class Servicio extends Helper {
  ...
  public function Servicio(){ $this->sql = new dbo(); }

  public function db($key){
    switch($key){
      case "insert": $query = "INSERT INTO servicio (servicio,descripcion,precio,status) VALUES ('".$this->servicio."','".$this->descripcion."','".$this->precio."','".$this->status."')";
	    break;
