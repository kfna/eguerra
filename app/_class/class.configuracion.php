...
class Configuracion extends Helper {
  var $id;
  var $meta;
  var $valor;
  var $descripcion;
  ...
  public function db($key){
    switch($key){
      case "insert":
        ...
        $query = "INSERT INTO configuracion (meta,valor,descripcion,status)
                  VALUES (
                    '".$this->meta."',
                    '".$this->valor."',
                    '".$this->descripcion."',
	    ...
	    break;
      case "update": $query = "UPDATE configuracion SET tipo_usuario = '".$this->tipo_usuario."',
		                                          nombre = '".$this->nombre."',
		                                          correo = '".$this->correo."',
